  ...
  main: async (client, msg, hasArgs) => {
    ...
    if (hasMR) {
      mainModule.db.serialize(() => {
        mainModule.db.run(`INSERT INTO servers VALUES(NULL, '${msg.guild.name.replace("'", '')}', '${msg.guild.id}', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL)`, (err) => {
